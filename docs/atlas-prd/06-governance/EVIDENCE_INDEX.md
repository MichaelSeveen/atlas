...
| EVD-P00-S08-002 | Phase 00 | committed static and clean-clone acceptance | all Phase 00; focus FND-010 and evidence integrity | `evidence/phase-00/acceptance/S08-post-commit-verification.md`; `S08-evidence-catalogue-postcommit.json` | implementation `6b09b4abfec050d6cdceb98af01f12bf0cab03af`; verified `431821f364165055d7e7ca7d69f047e860ee66aa` | committed static and detached same-host clean clone pass; Phase 00 not complete | `scripts/verify-s08.ps1 -CleanClone` | 2026-07-22 | same host, not independent machine; S08 race later closed by EVD-P00-S08-003; ruleset/review/release/encryption/routing gaps remain |
| EVD-P00-S08-003 | Phase 00 | hosted PR verification | FND-020..023; FND-025; FND-027; FND-054 | `evidence/phase-00/acceptance/S08-hosted-pr-verification.md` | PR head `10ed35b8d86a68d821c89f69822289f5ab655aa8` | five hosted jobs and constrained-pool race test pass; FND-020 remains partial | read-only `gh pr view 19`; `gh run view 29943586545`; job-log, ruleset, and release-run queries | 2026-07-22 | no required-check ruleset, independent owner approval, registry promotion, signature, provenance, or independent clean host |
