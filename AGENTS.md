...
- Git origin is `https://github.com/MichaelSeveen/atlas.git`. S07 PR #1 passed all five hosted jobs and merged as `f6ad535`; S08 is locally verified from an uncommitted worktree on that base. Hosted S08 race, clean-host, ruleset/review, registry/signature/provenance, and other recorded Phase 00 limitations remain outstanding.
