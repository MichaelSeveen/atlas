...
This repository is currently in **Phase 01 — Identity, access, tenancy, and privileged workforce controls**. P01-S01 planning, P01-S02 contract/decision closure, P01-S03 identity/audit persistence plus recovery revalidation, P01-S04 synthetic OIDC/session lifecycle, and P01-S05 merchant organization/tenancy behavior are complete at their bounded evidence depth. S04 includes durable idempotent step-up, live higher-assurance rotation, bounded account-enumeration, browser navigation/storage, additive policy-seed evolution, and ADR 0015 administrator-revocation evidence. S05 includes organization listing, active-tenant rotation, masked member listing, invitation issuance, ADR 0016 invitation-bound recipient acceptance, direct viewer/operator member role changes and removal, real PostgreSQL mutation races, and stored Unicode projection collision rejection. P01-S06 deny-by-default authorization, purpose, masking, and decision audit is next. Administrator-involved role transitions remain fail-closed pending the S07 maker-checker capability; administrator removal remains fail-closed pending exact fresh-step-up and last-administrator policy. Do not implement wallet or money-movement features before their prerequisite phases pass.
