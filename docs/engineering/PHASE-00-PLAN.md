...
| `FND-010` | Partial | S04 defines the complete constrained topology; S08 re-ran every named service, golden trace, outage, restore, and bounded teardown through one acceptance command. | The exact full wrapper still has not passed on a separate clean supported machine; same-host clean clone awaits commit. | `THR-019`, `THR-025`, `THR-042`, `THR-045` | S08 local pass; independent clean host open |
...
6. The [S08 report](../../evidence/phase-00/acceptance/S08-phase-00-acceptance-report.md) binds these results to `UNCOMMITTED_WORKTREE(base=f6ad53553e739ea44718cc1336920a37c3fd05bc)` and keeps post-commit, clean-host, ruleset/review, registry/signature/provenance, encryption, alert-routing, and product-replay gaps explicit.
