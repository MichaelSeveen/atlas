...
| `FND-010` | Partial | S04 defines the complete constrained topology; EVD-P00-S08-005 adds an exit-zero bounded Bun shutdown and ref-guarded release wiring for full live/history/supply/clean-clone S08 before publication. | The full container wrapper still has not passed on the separately administered hosted Docker runner. | `THR-019`, `THR-025`, `THR-042`, `THR-045` | Local closure pass; hosted live run open |
...
5. The original local live gate passed synthetic smoke, trace, telemetry outage, long-lock abort, real NATS, backup, and isolated restore but required a forced web stop. EVD-P00-S08-005 supersedes only that lifecycle limitation locally: the rebuilt Bun container exited `0` in `6303ms` within its eight-second deadline.
6. The [S08 pre-commit report](../../evidence/phase-00/acceptance/S08-phase-00-acceptance-report.md) preserves the original detailed live/history/supply results. [Post-commit verification](../../evidence/phase-00/acceptance/S08-post-commit-verification.md) binds the clean clone, [hosted PR verification](../../evidence/phase-00/acceptance/S08-hosted-pr-verification.md) binds constrained-pool race proof, [solo-governance verification](../../evidence/phase-00/acceptance/S08-solo-maintainer-governance.md) binds ruleset `19577130`, and [hosted-release closure preflight](../../evidence/phase-00/acceptance/S08-hosted-release-closure-preflight.md) binds the fail-before-publish/live-shutdown changes to implementation `eae43b6`. Independent clean-host, trigger-bound independent review, registry/signature/provenance, encryption, alert-routing, and product-replay gaps remain explicit.
