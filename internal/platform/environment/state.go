...
func completeRuntimeEnvironment(name Name, values map[string]string) (bool, error) {
	...
	for _, key := range []string{
		"ATLAS_IDENTITY_CSRF_KEY", "ATLAS_IDENTITY_NETWORK_SIGNAL_KEY", "ATLAS_IDENTITY_TRANSACTION_KEY",
...
func validateRuntimeValues(values map[string]string) error {
	for _, key := range []string{
		"ATLAS_ENVIRONMENT", "ATLAS_IDENTITY_CSRF_KEY", "ATLAS_IDENTITY_NETWORK_SIGNAL_KEY", "ATLAS_IDENTITY_TRANSACTION_KEY",
