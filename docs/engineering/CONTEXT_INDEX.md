...
listing, and ADR 0016 invitation-bound authentication/acceptance are implemented locally.
`P01-D16` is resolved; member role-change and removal mutations remain pending. Hard
order is `00 → {01,03}`,
`01 → 02`, `{01,02,04} → 05`,
...
| 01 — Identity/access/tenancy | [PHASE-01](../atlas-prd/02-phases/PHASE-01_IDENTITY_ACCESS_TENANCY.md) | Current: S01–S04 complete at bounded evidence depth; P01-S05 organization context, member listing, invitation issuance, and ADR 0016 recipient-bound acceptance implemented locally; member role-change/removal mutations pending |
