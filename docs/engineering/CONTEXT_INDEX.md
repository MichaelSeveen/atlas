...
exact fresh-step-up and last-administrator policy. P01-S06 deny-by-default authorization is next. Hard
order is `00 → {01,03}`,
`01 → 02`, `{01,02,04} → 05`,
...
| 01 — Identity/access/tenancy | [PHASE-01](../atlas-prd/02-phases/PHASE-01_IDENTITY_ACCESS_TENANCY.md) | Current: S01–S05 complete at bounded evidence depth; P01-S06 deny-by-default authorization, purpose, masking, and decision audit is next; admin-involved transitions fail closed pending S07 and administrator removal pending exact step-up/last-administrator policy |
