...
| `FND-010` | Partial | EVD-P00-S08-006 records fresh hosted Docker passes for the constrained topology, trace/outage, backup/restore, race, and exit-zero Bun shutdown. Attempt 1 then failed closed during disposable module-cache cleanup; correction `baf2e67` preserves a removable isolated cache. | Merge the correction and obtain a successful exit from the complete hosted outer S08 command. | `THR-019`, `THR-025`, `THR-042`, `THR-045` | Hosted mechanics pass; outer cleanup rerun open |
...
| `FND-023` | Partial | Committed backend/web images use digest-pinned bases, source labels, exact revision tags, recorded SHA-256 identity, and hardened execution; EVD-P00-S08-006 proves attempt 1 stopped before GHCR authentication when outer cleanup failed. | No GHCR digest is published or promoted; verify both registry digests through the corrected hosted release path. | `THR-013`, `THR-060` | Fail-closed gate observed; publication open |
| `FND-024` | Partial | The ref-guarded workflow puts full live/history/supply/clean-clone S08 before every registry mutation and attempt 1 skipped signing/attestation after preflight failure. | Rerun after protected correction merge and retain signature, provenance, SBOM attestation, identity, tamper/wrong-source, and unavailable-signing evidence. | `THR-013`, `THR-018`, `THR-020`, `THR-060` | Fail-closed attempt retained; signed release open |
...
S07 passes its local CI-equivalent, history/security, Git-baseline contract, and supply-chain commands. Four hashed SPDX surfaces, zero reachable Govulncheck findings, complete-history Gitleaks, deleted-history/action/contract/reference canaries, critical-CVE/license gates, and hardened backend/web image checks pass. PR #19 run `29949126130` later passed all five jobs plus the ADR 0012 declaration at `8c1032333356fe2d10b91ab46328f0a187290024`; ruleset `19577130` actively requires them. Therefore FND-020/FND-022/FND-027/FND-054 are satisfied at their stated scope, FND-026 is a partial accepted solo deviation, and FND-023/FND-024 remain partial pending release evidence.
...
6. The [S08 pre-commit report](../../evidence/phase-00/acceptance/S08-phase-00-acceptance-report.md) preserves the original detailed live/history/supply results. [Post-commit verification](../../evidence/phase-00/acceptance/S08-post-commit-verification.md) binds the clean clone, [hosted PR verification](../../evidence/phase-00/acceptance/S08-hosted-pr-verification.md) binds constrained-pool race proof, [solo-governance verification](../../evidence/phase-00/acceptance/S08-solo-maintainer-governance.md) binds ruleset `19577130`, [hosted-release closure preflight](../../evidence/phase-00/acceptance/S08-hosted-release-closure-preflight.md) binds local fail-before-publish changes, and [hosted release attempt 1](../../evidence/phase-00/acceptance/S08-hosted-release-attempt-1.md) preserves the fresh-host passes, cleanup failure, and skipped publication. Successful registry/signature/provenance, trigger-bound independent review, encryption, alert-routing, and product-replay gaps remain explicit.
...
- GitHub Actions/GHCR and keyless release identity are accepted by ADR 0011. ADR 0012 records the synthetic solo-maintainer deviation. Hosted jobs and active ruleset evidence now exist; independent review remains trigger-bound and unavailable/not claimed, while registry, signature, and provenance evidence do not exist.
...
- S08 traceability is requirement-specific. Remaining partial rows must be closed only when their post-commit, trigger-bound independent-review, clean-host, release, encryption, routing, or later product-flow evidence exists.
