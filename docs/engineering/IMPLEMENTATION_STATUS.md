...
- **Current slice:** [S08 — Phase 00 acceptance, restore, and evidence release](PHASE-00-PLAN.md#s08--phase-00-acceptance-restore-and-evidence-release) is implemented as `6b09b4abfec050d6cdceb98af01f12bf0cab03af`, post-commit/clean-clone verified at `431821f364165055d7e7ca7d69f047e860ee66aa`, and hosted-verified in PR #19 run `29943586545` against `10ed35b8d86a68d821c89f69822289f5ab655aa8`. Static, history/security, supply chain, live/restore, evidence canaries, the exact detached clone, and the Linux constrained-pool race test pass. Independent clean machine, protected rules, independent review, registry promotion, signing, and provenance remain open, so Phase 00 completion is not claimed.
...
- `FND-020` is partial: S07 run `29928153984` and S08 run `29943586545` successfully executed static/history/contracts, real PostgreSQL/NATS, both CodeQL languages, race/Gosec, supply-chain jobs, and the new constrained-pool race test. GitHub still reports no `main` ruleset, so required-check enforcement remains unproved.
...
S08 static/live/history/supply acceptance is preserved in EVD-P00-S08-001, committed static/clean-clone acceptance passes in EVD-P00-S08-002, and hosted race execution passes in EVD-P00-S08-003. The catalogue rejects content, stale source, and descendant code/config drift. Independent-machine, protected-ruleset, review, registry, signature, and provenance proof remain absent; overall Phase 00 completion is not claimed.
...
| Hosted GitHub policy and release identity remain incomplete | S07 and S08 PR jobs passed, but the rulesets API is empty, no independent owner approval exists, and no release has published registry/signature/provenance evidence. | Configure and evidence the `main` ruleset and independent review; then run the fail-closed release and retain registry/signature/attestation identifiers. |
