...
- `FND-003` — API, worker, and provider-simulator Go entry points build independently; only the API has a runtime lifecycle, now serving the three operational and fifteen approved identity/session/organization endpoints.
