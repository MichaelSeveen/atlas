...
- EVD-P00-S08-006 closes the hosted shutdown limitation: Docker observed the Bun container exit `0` in `218ms`. Release attempt 1 still failed later during disposable Go module-cache cleanup and published nothing.
